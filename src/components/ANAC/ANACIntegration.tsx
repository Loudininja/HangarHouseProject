...
import { Search, ExternalLink, CheckCircle, AlertTriangle, RefreshCw, Globe, FileText, Calendar, User, Wrench, Download, Eye, Plus } from 'lucide-react';
import { mockAircraft } from '../../data/mockData';
import { format } from 'date-fns';
import { ptBR } from 'date-fns/locale';
import { DirectivesConsultation } from './DirectivesConsultation';
import { AircraftConsultation } from './AircraftConsultation';
import { ProfessionalsConsultation } from './ProfessionalsConsultation';
...
export const ANACIntegration: React.FC = () => {
  ...
  const tabs = [
    { id: 'directives', label: 'Diretrizes (ADs)', icon: AlertTriangle },
    { id: 'aircraft', label: 'Consulta de Aeronaves', icon: Search },
    { id: 'professionals', label: 'Profissionais Habilitados', icon: User },
    { id: 'circulars', label: 'Cartas Circulares', icon: FileText },
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-gray-600">Consulta e sincronização com sistemas oficiais da ANAC</p>
        </div>
        <button
          onClick={bulkSync}
          disabled={loading}
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200">
        ...
        <div className="p-6">
          {activeTab === 'directives' && <DirectivesConsultation />}
          {activeTab === 'aircraft' && <AircraftConsultation />}
          {activeTab === 'professionals' && <ProfessionalsConsultation />}
          {activeTab === 'circulars' && <CircularLetters />}
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <a
                    href="https://sistemas.anac.gov.br/certificacao/DA/DA.asp"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-blue-50 hover:border-blue-300 transition-colors duration-200"
                  >
                  ...
                  <a
                    href="https://www.gov.br/anac/pt-br/assuntos/legislacao/legislacao-1/cartas-circulares"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-blue-50 hover:border-blue-300 transition-colors duration-200"
                  >
                  ...
                  <a
                    href="https://sistemas.anac.gov.br/sara/externo/consultarprofissional.asp"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-blue-50 hover:border-blue-300 transition-colors duration-200"
                  >
